...
for i in ['lobatto','gauss','gauss differential','radau','radau differential']:
    ...
    if i in ['gauss','gauss differential']:
        index = [i for i in range(len(control_solution)) if float(control_solution[i]) == control_solution[0]]
